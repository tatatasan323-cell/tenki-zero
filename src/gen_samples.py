...
INV = {}
rows = spread(3600000, ["野菜(葉物)", "野菜(根菜)", "果物", "青果セット"], 16)
...
norm += [("2026-05-06", "三崎水産", "まぐろ", 148000), ("2026-05-09", "三崎水産", "白身魚", 96000),
         ...
         ("2026-05-10", "大和クリーン", "店舗清掃(5店舗)", 40000), ("2026-05-24", "大和クリーン", "定期清掃(本部)", 15000)]
norm.sort()
